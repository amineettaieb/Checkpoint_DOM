...
var detailPrix = document.getElementById('detail-prix')
...
function handleDetail(e){
    ...
    detailPrix.innerHTML= 'Prix : TND ' +data[getId].prix;
    youSave.innerHTML= 'You save : (TND ' + data[getId].save + ')';
}
...
function addItem(){
    ...
    var clrNode=document.getElementById('item-body');
        ...
        cartList.map((cart)=>
        {
            ...
            totalAmount = totalAmount + cart.prix;
        ...
        document.getElementById('total-amount').innerHTML = 'Total Amount : TND ' + totalAmount;
        document.getElementById('total-items').innerHTML = 'Total Items : ' + totalItems;
        document.getElementById('you-saved').innerHTML = 'You Saved : TND ' + totalSaving;
